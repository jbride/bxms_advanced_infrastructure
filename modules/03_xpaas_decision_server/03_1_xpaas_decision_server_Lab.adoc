...
.. It is this resource URI utilized to drive the stateless rules engine of the _decision-server_ application.
+
The _id_ specified in the resource URI refers to the identifier of the container to invoke; in our case called:  _policyquote_.
