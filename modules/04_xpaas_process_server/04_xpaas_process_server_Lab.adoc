...
+
----
$ curl -X GET -H "Accept: application/json" --user kieserver:$kieserver_passord "$policyquote_app/kie-server/services/rest/server/queries/containers/991b463bc066da010a051daf87ff581d/process/instances"
----
+
Response:
+
